...
#define DEFINE_SCRIPT_BINDINGS(N) \
	...
	public: \
		...
		{ \
			...
			new ( &temporaryReturnStorage.m_vec ) Vector( (*ScriptConvertFuncPtrFromVoid<FUNC_TYPE>(pFunction))( SCRIPT_BINDING_ARGS_##N ) ); \
	...
	public: \
		...
		{ \
			...
			new ( &temporaryReturnStorage.m_ang ) QAngle( (*ScriptConvertFuncPtrFromVoid<FUNC_TYPE>(pFunction))( SCRIPT_BINDING_ARGS_##N ) ); \
